...
App.factory("Customer", function ($pwaRequest, $rootScope, $session, $timeout,
                                                        $injector, Application, Loader, Modal, Dialog, Url, SB, $http) {
    var factory = {
        events: [],
        customer: null,
        modal: null,
    ...
    // get login form's configured placeholders & in-app links
        $http({
            method: 'GET',
            url: Url.get("myaccountpro/mobile_view/getsettings"),
            cache: false,
            responseType:'json'
        }).then( function(data){ 
        	factory.login_form_settings = data.data;
        });
    ...
    factory.loginModal = function (scope, loginCallback, logoutCallback, registerCallback) {
        ...
        var layout = 'modules/myaccountpro/templates/l1/login.html';
        ...
        var loginPromise = Modal
            .fromTemplateUrl(layout, {
                scope: angular.extend(localScope, {
                    ...
                    _login_form_settings: factory.login_form_settings
                }),
    ...
    factory.login = function (data) {
        ...
        promise
            .then(function (result) {
                ...
                if( factory.login_form_settings.invalidLoginText ){
                    Dialog.alert('Error', factory.login_form_settings.invalidLoginText, 'OK', -1);
                }else{
